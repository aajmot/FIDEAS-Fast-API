...
async def get_payment(
    ...
    """Get a specific payment by ID with details and allocations"""
...
async def create_payment(
    ...
    """Create a new payment with details and allocations"""
    try:
...
async def get_document_payments(
    ...
    """Get all payments allocated to a specific document (invoice/order/expense)"""
    try:

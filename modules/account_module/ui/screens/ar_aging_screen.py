...
class ARAgingScreen(ctk.CTkFrame):
    ...
    def setup_ui(self):
        # Title
        title = ctk.CTkLabel(self, text="AR Aging Report", font=("Arial", 20, "bold"))
        title.pack(pady=10)
    ...
    def load_data(self):
        ...
        with db_manager.get_session() as session:
            ...
            for inv in invoices:
                days = (as_of_date - inv.voucher_date.date()).days
                ...
                if balance > 0.01:
                    ...
                    data.append([
                        inv.voucher_number,
                        inv.voucher_date.strftime("%Y-%m-%d"),
